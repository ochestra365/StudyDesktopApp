...
namespace StudyhistoryApp2
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            //키 값을 줘서 변동하지 않게 하기 위함이다.
            root.Nodes.Add(stuart);
            root.Nodes.Add(hanover);

            TrbList.Nodes.Add(root);
            //TrbList.ExpandAll();
        }
        //실행파일의 위치는 bin의 Debug다.
        //텍스트 비교가 아니라 키값비교로 해야 한다.
        private void TrbList_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if(e.Node.Text== "ANN1")
            {
                ...
                TxtDescription.Text = "앤 여왕은 1702년 3월 8일 잉글랜드와 스코틀랜드 " +
                    ...
                    "laborum nemo veniam optio " +
                    "quisquam earum aperiam esse soluta eligendi unde dolore impedit.";
            }
            else if (e.Node.Name == "GRG1")//화면을 구성하는 문자열과 키값은 분리하는 것이다.ㄴ
            {
